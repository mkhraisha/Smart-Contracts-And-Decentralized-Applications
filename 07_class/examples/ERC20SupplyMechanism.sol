...
contract ERC20Mintable is IERC20 {
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0),"ERC20: transfer from zero transfer");
...
contract ERC20MinerWithReward is ERC20Mintable("GBC Token", "GBC") {
...
contract ERC20WithAutoMinerReward is ERC20Mintable("GBC Token", "GBC") {
